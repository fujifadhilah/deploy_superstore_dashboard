...
# Helper function: agar ada format koma
...
with mx_order:
    ...
    st.metric("Count_Orders", value=format_big_number(curr_order), delta=f'{order_diff_pct:.2f}%')
...
with mx_customer:
    ...
    st.metric("Count_Customers", value=curr_customer, delta=f'{customer_diff_pct:.2f}%')
...
st.header("Category Segment Performance")
